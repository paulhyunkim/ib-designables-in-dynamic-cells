...
extension ViewController: UITableViewDataSource {
  ...
  func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
    ...
    let cell = tableView.dequeueReusableCellWithIdentifier("MyCell", forIndexPath: indexPath) as DesignableCell
    
    if let customView = cell.subviews[0].subviews[0] as? CustomCellAView {
